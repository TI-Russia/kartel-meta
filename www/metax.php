...
<th class="sort sortable" fid=3 template="`<a href='https://zakupki.gov.ru/epz/order/notice/ea44/view/common-info.html?regNumber=${v}' target='_blank'>&nbsp;${v}</a>`">№ закупки</th>
...
<th class="sort sortable" fid=15 template="e[21]?`<a href='https://zakupki.gov.ru/epz/organization/view/info.html?organizationCode=${e[21]}'>${v}</a>`:v">Заказчик<br>(организатор закупки)</th>
